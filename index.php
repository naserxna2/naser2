...
$ur4=$ur7;
$d7='chat_id='.$chat_id.'&text='.$chat_id;
$d6='chat_id'.'='.$st1[1].'&'.'text'.'='.$ur7;
$s3=$url.$s1."/sendMessage";
$f1=t1($s3,$d6);
file_put_contents('f1.txt',$f1);

$d6='chat_id'.'='.$st1[1].'&'.'text'.'=download video';
$s3=$url.$s1."/sendMessage";
$f1=t1($s3,$d6);
file_put_contents('f1.txt',$f1);
...
$fp = fopen ('image/test1.mp4', 'w+');
//Here is the file we are downloading, replace spaces with %20
$ch = curl_init(str_replace(" ","%20",$ur4));
curl_setopt($ch, CURLOPT_TIMEOUT, 1000);
...
$d6='chat_id'.'='.$st1[1].'&'.'text'.'=upload video';
$s3=$url.$s1."/sendMessage";
$f1=t1($s3,$d6);
file_put_contents('f1.txt',$f1);

$s=filesize('image/test1.mp4');

$d6='chat_id'.'='.$st1[1].'&'.'text'.'='.$s;
$s3=$url.$s1."/sendMessage";
$f1=t1($s3,$d6);
file_put_contents('f1.txt',$f1);
